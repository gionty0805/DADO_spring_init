...
<div class="container mt-5">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/shop/list/${shopVO.shop_id}/${shopVO.pageVO.page_no}">상품관리</a></li>
    ...
    <div class="row">
        <c:choose>
            <c:when test="${shop.post_id != 0}">
                <c:set var="title" value="${shopVO.title}"/>
                <c:set var="cont" value="${shopVO.cont}"/>
        ...
        <div class="col-12 mb-1">
            <form method="post" action="${sort == 'update' ? '/shop/update' : '/shop/write'}" id="frm_write">
                <div class="row">
                ...
                <input type="hidden" name="post_id" value="${shopVO.post_id}"/>

                <c:if test="${sort == 'reply'}">
                    <input type="hidden" name="parent_id" value="${shopVO.post_id}"/>
                    <input type="hidden" name="origin_no" value="${shopVO.origin_no}"/>
                    <input type="hidden" name="parent_layer" value="${shopVO.group_layer}"/>
                </c:if>
        ...
        <div class="col-12 mt-3 ${sort == 'update' ? '' : 'd-none'}">
            <c:forEach var="file" items="${shopVO.file_list}">
